...
export function TransactionsPageProvider({
	...
	const accountsState = useAccountsState(user.id, 1, '');
	const accountTypesState = useAccountTypesState();
	const categoriesState = useCategoriesState(user.id, 1, '');
	const descriptionsState = useDescriptionsState(user.id, descriptionSearch);
